<?php
file_put_contents('/tmp/re2',date('H:i:s').': '.print_r(file_get_contents('php://input', 'r'),true). ' '.print_r($_REQUEST,true) . ' '.print_r($_SERVER,true),FILE_APPEND);
...
$content = $_REQUEST['content'] = '{"sname":"borrow.summary","bid":"1123","pname":"ios"}';//json格式
$token   = $_REQUEST['token'] = 'bcdd88f6f6ba2d4877aed6366be8afa9';
/*
